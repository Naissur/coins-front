(defproject coins-front "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :compiler {:main coins-front.core
                           ...
                           :output-to "resources/public/js/compiled/coins_front.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/coins_front.js"
                           :main coins-front.core
